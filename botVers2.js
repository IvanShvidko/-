...
bot.onText(/\/help/, async (msg) => 
{
  console.log(msg);
  const chatId = msg.chat.id;
  await bot.sendMessage(chatId, 'Чтобы заполнить данными таблицу, нужно ввести команду "/addItem TEXT, TEXT", где TEXT - ваши введённые данные');
  await bot.sendMessage(chatId, 'Чтобы удалить запись из таблицы, нужно ввести команду "/deleteItem ID", где ID - номер записи в таблице');
});
